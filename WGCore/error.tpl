...
<table dir='ltr' border='1' cellspacing='0' cellpadding='1'>
	...
	<tr><td bgcolor='#eeeeec' align='center' style="padding-left: 20px; padding-right: 20px;">{{$cnt - $i}}</td><td bgcolor='#eeeeec' align='center' style="padding-left: 20px; padding-right: 20px;">{{Error_Handler::getFunctionName($stack[$i])}}</td><td bgcolor='#eeeeec' align='center' style="padding-left: 20px; padding-right: 20px;">{{Error_Handler::getFunctionLocation($stack[$i])}}</td></tr>
	{{/for}}
</table>
</div>
<hr size="1" />
<div style="margin-top: 20px; color: #ff8c00; font-size: 12px;">
	<p style="text-align: center;">
		Powered By WGCore Framework {{$smarty.const.WGCORE_VERSION}}, written by <a href="http://jackyyf.com/" target="_blank">Jack Yu</a> <br />
